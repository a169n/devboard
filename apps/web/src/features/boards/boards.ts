...
export const createBoard = async (title: string) => (await api.post('/boards', { title })).data.data;

export const updateBoard = async (boardId: string, title: string) =>
  (await api.patch(`/boards/${boardId}`, { title })).data.data;

export const deleteBoard = async (boardId: string) => (await api.delete(`/boards/${boardId}`)).data.data;
...
export const deleteColumn = async (columnId: string) => (await api.delete(`/columns/${columnId}`)).data.data;

export const createCard = async (columnId: string, payload: { title: string; description?: string; priority: Priority }) =>
...
export const deleteCard = async (cardId: string) => (await api.delete(`/cards/${cardId}`)).data.data;
